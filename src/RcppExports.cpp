...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(dilateImage(mat, kernel, niter));
    return __result;
END_RCPP
}
// drawRectangle
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(drawRectangle(mat, corner1, corner2, value, thickness));
    return __result;
END_RCPP
}
// equalizeImageHist
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(equalizeImageHist(mat));
    return __result;
END_RCPP
}
// erodeImage
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type kernel(kernelSEXP);
    Rcpp::traits::input_parameter< int >::type niter(niterSEXP);
    __result = Rcpp::wrap(erodeImage(mat, kernel, niter));
    return __result;
END_RCPP
}
// findBoundaryPoints
...
BEGIN_RCPP
    ...
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< Rcpp::IntegerMatrix >::type mat(matSEXP);
    __result = Rcpp::wrap(findBoundaryPoints(mat));
    return __result;
END_RCPP
}
// findCornerSubPix
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(findCornerSubPix(image, corners, win, max_iter, criteria));
    return __result;
END_RCPP
}
// generateQuads
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(generateQuads(binary_mat, edge_mat, perim_min, perim_max, quad_fit_max, poly_cont_min, poly_cont_max, poly_asp_min, approx_thresh));
    return __result;
END_RCPP
}
// intCornersFromQuads
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(intCornersFromQuads(quads, max_dist));
    return __result;
END_RCPP
}
// orderCorners
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(orderCorners(int_corners, nx, ny));
    return __result;
END_RCPP
}
// meanBlurImage
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type mat(matSEXP);
    Rcpp::traits::input_parameter< int >::type kernel(kernelSEXP);
    __result = Rcpp::wrap(meanBlurImage(mat, kernel));
    return __result;
END_RCPP
}
// rgbToGray
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(rgbToGray(ch1, ch2, ch3));
    return __result;
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(thresholdImageMatrix(mat, thresh_mat, delta, type));
    return __result;
END_RCPP
}
